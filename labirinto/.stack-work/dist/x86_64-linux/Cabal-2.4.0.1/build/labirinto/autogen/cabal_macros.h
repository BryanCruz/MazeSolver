...
/* package labirinto-0.1.0.0 */
#ifndef VERSION_labirinto
#define VERSION_labirinto "0.1.0.0"
#endif /* VERSION_labirinto */
#ifndef MIN_VERSION_labirinto
#define MIN_VERSION_labirinto(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_labirinto */
...
#define CURRENT_COMPONENT_ID "labirinto-0.1.0.0-5aKBjrVeReGFMjDT3Kl8X2-labirinto"
